...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an dablu management bot [✨](https://telegra.ph/file/c91a6742ba0f21295b7cc.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text=f"About {dispatcher.bot.first_name}", callback_data="https://t./me/Dabllu"),
    ],
    [
