...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an Dablu management bot [✨](https://te.legra.ph/file/ac3efab2078135ce52641.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text=f"About {dispatcher.bot.first_name}", callback_data="@Dabllu"),
    ],
    [
